...
+ Характеристики:
  + Основан на протоколе QUIC, который работает поверх UDP вместо TCP и включает в себя TLS 1.3 для шифрования данных.
